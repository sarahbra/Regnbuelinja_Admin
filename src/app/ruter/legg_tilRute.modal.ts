...
export class LeggTilRuteModal {
    ...
    allForms = {
        ...
        endepunktForm: [null, Validators.compose([Validators.required, Validators.pattern('[a-zA-ZøæåØÆÅ\\-. ]{2,30}')])],
        prisForm: [null, Validators.compose([Validators.required, Validators.pattern('^-?[0-9]\\d*(\\.\\d*)?$')])]
    }
